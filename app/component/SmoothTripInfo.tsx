    ...
    <>
        ...
        >
          ...
          <div className="flex flex-col space-y-5 text-center">
            ...
            <div>
              ...
              find many hotels in Asia. You can also get train tickets, book car
        ...
        <div>
          ...
          >
            ...
            <div className="flex flex-col space-y-5 text-center md:text-left">
              ...
              <div>
                Find discounts for your favorite flights and hotels to save more
                for your upcoming vacation! Make your dream vacation come true
                with a special promo provided by tiket.com. There is no reason
                to delay your vacation!
              </div>

              <div className="text-base font-bold">Tiket Rewards Benefits.</div>
              <div>
                Enjoy the Tiket Rewards benefits in Tiket Points that you can
                redeem with discounts.
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="md:block hidden">
        ...
        >
          ...
          <div className="flex flex-col space-y-5 text-left flex-1">
            <div className="text-3xl font-bold">
              Book Tickets and Plan Your Holiday with Ease
            </div>
        ...
        <div>
          ...
          >
            ...
            <div className=" md:mb-0 md:mr-8 flex-1">
              <Image
                className="w-80 pr-10 md:w-auto "
                src={Kanan}
                alt={"wasd"}
              />
            </div>
        ...
        >
          ...
          <div className="flex-1 text-left flex flex-col space-y-5">
            <div className="text-3xl font-bold">
              Book the Cheap Flight Tickets to Your Favorite Destinations
            </div>
